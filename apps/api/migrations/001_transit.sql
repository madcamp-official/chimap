...
CREATE TABLE IF NOT EXISTS bus_route_stops (
  route_internal_id INTEGER NOT NULL REFERENCES bus_routes(id) ON DELETE CASCADE,
  stop_internal_id INTEGER NOT NULL REFERENCES bus_stops(id) ON DELETE CASCADE,
